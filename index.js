  ...
  try {
    if (settings.ep_prompt_for_name){
       if(!settings.ep_prompt_for_name.link){
         console.warn("No link set for ep_prompt_for_name,
          add ep_prompt_for_name.link to settings.json");
       ...
       if(!settings.ep_prompt_for_name.text){
         ...
         console.warn("No text set for ep_prompt_for_name,
            add ep_prompt_for_name.text to settings.json");
       }else{
       ...
       if(!settings.ep_prompt_for_name.before){
         ...
         console.info("No before set for ep_prompt_for_name,
            this may be intentional, add ep_prompt_for_name.before to settings.json");
       }else{
       ...
       if(!settings.ep_prompt_for_name.classes){
         ...
         console.info("No classes set for ep_prompt_for_name,
            this may be intentional, add ep_prompt_for_name.classes to settings.json");
       }else{
         ep_prompt_for_name.classes = settings.ep_prompt_for_name.classes;
       }
       if(!settings.ep_prompt_for_name.after){
         console.info("No after set for ep_prompt_for_name, this may be intentional,

         add ep_prompt_for_name.classes to settings.json");
       }else{
